        ...
        <header className="bg-slate-200 shadow-md">
            <div className="flex justify-between items-center max-w-6xl mx-auto p-3">
                ...
                <ul className="flex gap-4 ">
                    <Link to='/'>
                        <li className="hidden sm:inline text-blue-700 hover:text-green-600">Home</li>
                    </Link>
                    <Link to='/about'>
                        <li className="hidden sm:inline text-blue-700 hover:text-green-600">About</li>
                    </Link>
                    <Link to='/profile'>
                        {currentUser ? (
                            <img
                            ...
                            <li className="text-blue-700 hover:text-green-600">Sign in</li>
                        )}
                    </Link>
                </ul>
            </div>
